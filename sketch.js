...
function setup() {
	...
	bob1 = Bodies.circle(400, 400, 25, bob_options);

	World.add(world, bob1)

	bob2 = Bodies.circle(320, 400, 25, bob_options);
	World.add(world, bob2)

	bob3 = Bodies.circle(360, 400, 25, bob_options);
	World.add(world, bob3)

	bob4 = Bodies.circle(440, 400, 25, bob_options);
	World.add(world, bob4)

	bob5 = Bodies.circle(480, 400, 25, bob_options);
	...
	if (keyCode===UP_ARROW)
	 {
		...
		Matter.Body.applyForce(bob2, { x: 0, y: 0 }, { x: -0.01, y: 0 });
